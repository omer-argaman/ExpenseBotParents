...
category_map = {
    ...
    # Home Expenses
    "Mortgage": ["mortgage", "mortage", "Mortgage insurance"],
    ...
    "Public Transportation": ["train", "taxi", "bus", "metro", "tram", "cab", "subway", "ride", "public", "transport"],
    "Parking": ["parking", "garage", "space", "charging", "park", "pango", "cello", "cellopark"],
    "Car Insurance Toyota": ["Car Insurance Toyota", "Insurance toyota"],
    "Car Insurance MG": ["Car Insurance MG", "Insurance MG"],
    "Maintenance Toyota": ["Test Toyota", "Tipul toyota", "Musah toyota", "Garage toyota", "Mechanic toyota"],
    ...
    "Health Care": ["Health insurance", "Clalit", "Clalit Shahar", "Clalit Ilanit", "Clalit Nadav", "Clalit Omer",
    ...
    "Dining Out": ["dining", "restaurant", "meal", "food", "breakfast", "lunch", "dinner", "eat","takeout", "delivery"
    ],
    "Beer / Wine": ["beer", "wine", "alcohol", "bar", "cocktail", "drink", "vodka",
        "whiskey", "liquor"],
    "Other (Daily)": ["daily living other", "other daily living", "miscellaneous living", "Other (Daily)", "Other Daily", "other", "cosmetics", "laser",
        "personal", "gym", "present", "presents"
    ],
    "Cloths": [ "cloths", "shirt", "pants", "dress", "clothes", "cloth", "tshirt", "t-shirt", "t shirt"],
    "Kids": [ "Naama", "Alon", "Nadav", "Omer", "Naama tzofim", "tzofim", "Naama Studio", "Studio", 
        "Naama Driving Licence", "Driving Licence", "Driving Lessons", "Driving Lesson", "Matnas"],
    "Education": ["School", "Naama school", "Tel Aviv Univercity", "Uni", "Univercity", "Education", "Edu",
        "Private lesson", "Privet Lesson", "Shiur prati", "Lesson", "Shiur"],
    "Entertainment": ["entertainment", "movie", "Movies", "theater", "show", "concert", "game", "festival", "fun", "games"
